...
" General colors
hi Normal           guifg=#f6f3e8     guibg=black       gui=NONE      ctermfg=255        ctermbg=16        cterm=NONE
hi NonText          guifg=#070707     guibg=black       gui=NONE      ctermfg=232       ctermbg=16        cterm=NONE

hi Cursor           guifg=black       guibg=white       gui=NONE      ctermfg=16       ctermbg=231       cterm=NONE
hi LineNr           guifg=#3D3D3D     guibg=black       gui=NONE      ctermfg=237    ctermbg=16        cterm=NONE
...
hi StatusLineNC     guifg=black       guibg=#202020     gui=NONE      ctermfg=16        ctermbg=234    cterm=NONE  
...
hi WildMenu         guifg=green       guibg=yellow      gui=NONE      ctermfg=46       ctermbg=226      cterm=NONE
hi PmenuSbar        guifg=black       guibg=white       gui=NONE      ctermfg=16       ctermbg=231       cterm=NONE
"hi Ignore           guifg=gray        guibg=black       gui=NONE      ctermfg=250        ctermbg=16        cterm=NONE

hi Error            guifg=NONE        guibg=NONE        gui=undercurl ctermfg=NONE       ctermbg=124         cterm=NONE     guisp=#FF6C60 " undercurl color
...
if version >= 700 " Vim 7.x specific colors
  ...
  hi Pmenu          guifg=#f6f3e8     guibg=#444444     gui=NONE      ctermfg=255        ctermbg=238        cterm=NONE
  hi PmenuSel       guifg=#000000     guibg=#cae682     gui=NONE      ctermfg=16        ctermbg=186        cterm=NONE
...
hi Todo             guifg=#8f8f8f     guibg=NONE        gui=NONE      ctermfg=245         ctermbg=NONE        cterm=NONE
...
hi Operator         guifg=white       guibg=NONE        gui=NONE      ctermfg=231       ctermbg=NONE        cterm=NONE
...
hi rubyEscape                  guifg=white        guibg=NONE      gui=NONE      ctermfg=231           ctermbg=NONE      cterm=NONE
...
"hi rubyGlobalVariable          guifg=#FFCCFF      guibg=NONE      gui=NONE      ctermfg=225      ctermbg=NONE      cterm=NONE  "yield
hi rubyStringDelimiter         guifg=#336633      guibg=NONE      gui=NONE      ctermfg=239     ctermbg=NONE      cterm=NONE
"rubyInclude
"rubySharpBang
"rubyAccess
